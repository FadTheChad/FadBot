// export type Permissions = 'CREATE_INSTANT_INVITE' | 'KICK_MEMBERS' | 'BAN_MEMBERS' |
...
//     'MANAGE_EMOJIS_AND_STICKERS' | 'USE_APPLICATION_COMMANDS' | 'CREATE_PUBLIC_THREADS' |
//     'CREATE_PRIVATE_THREADS' | 'USE_EXTERNAL_STICKERS' | 'SEND_MESSAGES_IN_THREADS' | 'BOT_DEV'
// yes i know.

import { PermissionString } from 'discord.js'

export type Permissions = PermissionString | 'BOT_DEV'